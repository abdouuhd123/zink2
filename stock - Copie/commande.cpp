...
bool commande::ajouter()
{
    ...
    query.prepare("INSERT INTO COMMANDE (DATE_COMMANDE, QUANTITE, ID_PRODUIT, ID_FOURNISSEUR, ID_COMMANDE) "
                        "VALUES (:date, :quantite, :id_produit, :id_fournisseur, :id_commande)");
