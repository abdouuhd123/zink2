...
"}"));
    ...
    {
        uiemail->setWindowTitle(QApplication::translate("uiemail", "Dialog", Q_NULLPTR));
        label->setText(QString());
        exitBtn->setText(QApplication::translate("uiemail", "retour", Q_NULLPTR));
        port->setText(QApplication::translate("uiemail", "465", Q_NULLPTR));
        uname->setText(QApplication::translate("uiemail", "ikbel.khemiri@esprit.tn", Q_NULLPTR));
        uname->setPlaceholderText(QApplication::translate("uiemail", "Enter your E-mail", Q_NULLPTR));
        messageL->setText(QApplication::translate("uiemail", "Message:", Q_NULLPTR));
        subjectL->setText(QApplication::translate("uiemail", "Sujet :", Q_NULLPTR));
        paswd->setInputMask(QString());
        paswd->setText(QString());
        paswd->setPlaceholderText(QApplication::translate("uiemail", "entrer votre mot de passe", Q_NULLPTR));
        server->setText(QApplication::translate("uiemail", "smtp.gmail.com", Q_NULLPTR));
        recipantL->setText(QApplication::translate("uiemail", "Email recipiant :", Q_NULLPTR));
        smtpserverL->setText(QApplication::translate("uiemail", "Serveur-Smtp:", Q_NULLPTR));
        attachmentL->setText(QApplication::translate("uiemail", "Attachement:", Q_NULLPTR));
        subject->setText(QApplication::translate("uiemail", "Bienvenue", Q_NULLPTR));
        subject->setPlaceholderText(QApplication::translate("uiemail", "Enter subject", Q_NULLPTR));
        sendPB->setText(QApplication::translate("uiemail", "Send", Q_NULLPTR));
        serverportL->setText(QApplication::translate("uiemail", "Serveur port:", Q_NULLPTR));
        usernameL->setText(QApplication::translate("uiemail", "Username:", Q_NULLPTR));
        browseBtn->setText(QApplication::translate("uiemail", "importer...", Q_NULLPTR));
        file->setText(QString());
        file->setPlaceholderText(QApplication::translate("uiemail", "importer votre fichier", Q_NULLPTR));
        passwordL->setText(QApplication::translate("uiemail", "mot de passe", Q_NULLPTR));
