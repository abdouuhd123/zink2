...
"border:transparent;"));
    ...
    {
        chariot->setWindowTitle(QApplication::translate("chariot", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("chariot", "num_chariot", Q_NULLPTR));
        label_2->setText(QApplication::translate("chariot", "reference", Q_NULLPTR));
        pushButton->setText(QString());
        pushButton_2->setText(QString());
        radioButton_active->setText(QApplication::translate("chariot", "Active", Q_NULLPTR));
        radioButton_nonactive->setText(QApplication::translate("chariot", "Non active", Q_NULLPTR));
        label_3->setText(QApplication::translate("chariot", "Etat", Q_NULLPTR));
        label_4->setText(QApplication::translate("chariot", "Heure", Q_NULLPTR));
        pushButton_tri->setText(QApplication::translate("chariot", "tri", Q_NULLPTR));
        pushButton_statistique->setText(QApplication::translate("chariot", "Statistique", Q_NULLPTR));
        label_5->setText(QApplication::translate("chariot", "Rechercher", Q_NULLPTR));
        pushButton_modifier->setText(QString());
        pushButton_effectuer->setText(QApplication::translate("chariot", "effectuer", Q_NULLPTR));
