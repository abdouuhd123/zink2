...
"border:transparent;"));
    ...
    {
        produit->setWindowTitle(QApplication::translate("produit", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("produit", "id_produit", Q_NULLPTR));
        label_2->setText(QApplication::translate("produit", "date_limite", Q_NULLPTR));
        pushButton->setText(QString());
        pushButton_2->setText(QString());
        pushButton_tri->setText(QApplication::translate("produit", "tri", Q_NULLPTR));
        pushButton_mail->setText(QApplication::translate("produit", "mail", Q_NULLPTR));
