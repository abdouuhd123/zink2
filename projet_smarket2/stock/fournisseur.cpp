...
bool Fournisseur::ajouter()
{
    ...
    query.prepare("INSERT INTO FOURNISSEUR (ID_FOURNISSEUR,ADRESSE, TELEPHONE, NOM) "
                        "VALUES (:Id_fournisseur,:Adresse, :Telephone, :Nom)");
    ...
    QSqlQuery query ;
            ...
            qDebug() << s  ;
                ...
                if(s.toInt())
                {
                    ...
                    cherche+=s;
                    cherche+="%";
                    QString rec=("SELECT * FROM FOURNISSEUR where  (ID_FOURNISSEUR like :Id_fournisseur) or (TELEPHONE like :Telephone) ");
                    query.prepare(rec);
