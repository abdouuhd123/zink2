...
QT_MOC_LITERAL(1, 10, 24), // "on_addAttachment_clicked"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 20) // "on_sendEmail_clicked"

    },
    "SendEmail\0on_addAttachment_clicked\0\0"
...
void SendEmail::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SendEmail *_t = static_cast<SendEmail *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SendEmail::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SendEmail.data,
      qt_meta_data_SendEmail,  qt_static_metacall, nullptr, nullptr}
};
...
void *SendEmail::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SendEmail.stringdata0))
        return static_cast<void*>(const_cast< SendEmail*>(this));
