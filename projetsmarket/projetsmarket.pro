...
RESOURCES += \
    ...
    parkingintegration/ressource.qrc \
    connection/image.qrc \
    connection/ressources.qrc

DISTFILES += \
    appsecurity/appsecurity.pro.user \
    parkingintegration/parkingintegration.pro.user \
    parkingintegration/gif.gif \
    parkingintegration/s.gif \
    parkingintegration/Sans-titre-1.gif \
    parkingintegration/choisir.png \
    parkingintegration/choisiradminclient.png \
    parkingintegration/gererzone.png \
    connection/connection.pro.user \
    connection/connection.pro.user.4.8-pre1 \
    connection/connection.pro.user.38b2bef.20 \
    connection/connection.pro.user.53a0ad4.xml \
    connection/connection.pro.user.58375af.20 \
    connection/connection.pro.user.58375af.xml \
    connection/connection.pro.user.bd4b682.4.8-pre1 \
